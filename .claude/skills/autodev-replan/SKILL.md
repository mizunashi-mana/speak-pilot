...
allowed-tools: Read, Write, Edit, MultiEdit, Update, Bash(mkdir *), Glob, Grep, AskUserQuestion, WebSearch, WebFetch, mcp__github__list_issues, mcp__github__search_issues
---
